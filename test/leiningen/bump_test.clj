...
(defn- verify-project-clj-write [version]
  ...
  (testing "Stepping patch version"
    (let [project {:version "5.4.8"}]
      (mock/with-mock
        ...
        (verify-project-clj-write "5.4.9"))))
    ...
    (let [project {:version "5.4.8-SNAPSHOT"}]
      (mock/with-mock
        [spit nil
         slurp (get-mock-project-clj (:version project))]
        (plugin/bump project "patch")
        (verify-project-clj-write "5.4.8"))))
  ...
  (testing "Stepping major version"
    (let [project {:version "5.4.8-SNAPSHOT"}]
      (mock/with-mock
        ...
        (verify-project-clj-write "6.0.0"))))
  ...
  (testing "Stepping minor version"
    (let [project {:version "5.4.8-SNAPSHOT"}]
      (mock/with-mock
        ...
        (verify-project-clj-write "5.5.0")))))
  ...
  (testing "Prepare for new development iteration for 6.0.0"
    (let [project {:version "6.0.0"}]
      (mock/with-mock
        ...
        (verify-project-clj-write "6.0.1-SNAPSHOT"))))
    ...
    (let [project {:version "5.4.8"}]
      (mock/with-mock
        [spit nil
         slurp (get-mock-project-clj (:version project))]
        (plugin/bump project dev)
        (verify-project-clj-write "5.4.9-SNAPSHOT")))))
